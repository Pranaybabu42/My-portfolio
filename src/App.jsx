...
import PageEntry from './components/layout/PageEntry'
...
function App() {
  ...
  return (
    <PageEntry reducedMotion={reducedMotion}><div className="noise-overlay relative isolate min-h-screen bg-bg">
      ...
      <div className="relative z-[20]">
        ...
        <main id="main-content" className="app-main">
          <TechOrbit reducedMotion={reducedMotion} />
